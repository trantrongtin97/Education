using _4._AspNetCore_WebApp_PartialViews.Models;
using Microsoft.AspNetCore.Mvc;

namespace _4._AspNetCore_WebApp_PartialViews.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Details(int Id)
        {
            ...
            return View("Default",ProductDetails);
        }

        //Product/DetailsUsingPartial/1
        public ActionResult DetailsUsingPartial(int Id)
        {
            var ProductDetails = products.FirstOrDefault(prd => prd.ProductID == Id);
            return View("Partial", ProductDetails);
        }

        //Product/DetailsUsingTagHelper
        public ActionResult DetailsUsingTagHelper()
        {
            return View("TagHelper", products);
        }

        //Product/SummaryUsing/1
        public ActionResult SummaryUsing(int Id)
        {
            var ProductDetails = products.FirstOrDefault(prd => prd.ProductID == Id);
            return View("SummaryUsing", ProductDetails);
        }
    }
}
